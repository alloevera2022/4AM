...
export default function Main() {
    ...
    <div className="main__content">
        <div className="main__left-block">
            ...
            <div className="main_button"><ConnectButton label="Get yours"/></div>
            ...
            <div className="main__left-block-content-links">
                    <div className="main-link"><a href="mailto:info@AXXISproject.io"><img src={emailLogo.src} className="sl_logos"/></a><a href="mailto:info@AXXISproject.io"><p className="sl_text">info@AXXISproject.io</p></a></div>
                    <div className="main-link"><a href="https://t.me/AXXISinfo"><img src={telegramLogo.src} className="sl_logos"/></a><a href="https://t.me/AXXISinfo"><p className="sl_text">@AXXIS</p></a></div>
                    <div className="main-link"><a href="https://twitter.com/XXS_crypto"><img src={xLogo.src} className="sl_logos"/></a><a href="https://twitter.com/XXS_crypto"><p className="sl_text">@AXXIS_project</p></a></div>                 
            </div>
            </div>
        </div>
